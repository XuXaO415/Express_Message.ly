...
class User {
    ...
    static async messagesFrom(username) {
        const results = await db.query(`SELECT m.id, to_username, m.first_name, m.last_name, m.to_phone,
    ...
    static async messagesTo(username) {
        const result = await db.query(`SELECT m.id, m.from_username, u.first_name, u.last_name, 
